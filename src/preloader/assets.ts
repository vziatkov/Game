...
const centralSvgString = `
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" height="3122" width="3122">
        ...
        <g transform="translate(1561,1561)">
            <use style="fill:red; stroke:red; stroke-width:10" xlink:href="#triya"/>
            <use transform="rotate(120)" style="fill:white; stroke:white; stroke-width:10" xlink:href="#triya"/>
            <use transform="rotate(240)" style="fill:black; stroke:white; stroke-width:20" xlink:href="#triya"/>
